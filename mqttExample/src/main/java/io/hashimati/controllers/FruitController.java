...
import io.hashimati.mqtt.FruitMqttClient;
...
public class FruitController {
    ...
    @Inject private FruitMqttClient fruitMqttClient;
    ...
    public HashMap<String, String> save(@SpanTag("save.fruit") @NonNull @Body Fruit fruit  ){
        log.info("Saving  Fruit : {}", fruit);
        //TODO insert your logic here!

        fruitMqttClient.sendOrder(fruit);
        //saving Object
        return new HashMap<>(){{
            put("message", "Successfully receive the fruit Object "); 
        }};
    }
